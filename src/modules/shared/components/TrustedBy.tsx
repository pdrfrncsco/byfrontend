  ...
  const defaultLogos = [
    {
      ...
      alt: 'African Football Federation Logo',
    },
    {
      ...
      alt: 'Angolan Professional Football League Logo',
    },
    {
      ...
      alt: 'African Club Competition Logo',
    },
    {
    ...
    },
    {
      ...
      alt: 'Continental African Sports Agency Logo',
    },
  ]
  ...
  return (
    <section className="py-xl bg-surface-container-low border-y border-outline-variant">
      <div className="max-w-container-max mx-auto px-gutter text-center">
        <p className="font-label-sm text-label-sm text-on-surface-variant mb-lg uppercase tracking-widest">
          Confiança das Maiores Instituições
        </p>
