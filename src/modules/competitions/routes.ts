...
export const competitionRoutes = {
  ...
  matchCenterHub: (compId: string) => ROUTES.MATCH_CENTER_HUB(compId),
  adminMatchCenterHub: (compId: string) => ROUTES.DASHBOARD_MATCH_CENTER_HUB(compId),
  matchDetail: (compId: string, matchId: string) => ROUTES.MATCH_CENTER(compId, matchId),
  adminMatchDetail: (compId: string, matchId: string) => ROUTES.DASHBOARD_MATCH_CENTER(compId, matchId),
