  ...
  return (
    <Link to={`/competitions/${competition.id}`} className="group block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-2xl">
      <Card
        variant="flat"
        padding="lg"
        className="group relative overflow-hidden rounded-2xl border border-outline-variant/80 bg-surface-container-low transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:bg-surface-container-high hover:shadow-[0_20px_40px_-28px_rgba(15,23,42,0.35)]"
      >
