...
export function mapMatchFromBackend(data: any): Match {
  ...
  return {
    ...
    homeTeamShortName: data.home_club_short_name || data.homeTeamShortName || '',
    homeTeamAcronym: data.home_club_acronym || data.homeTeamAcronym || '',
    home_club_short_name: data.home_club_short_name || data.homeTeamShortName || '',
    home_club_acronym: data.home_club_acronym || data.homeTeamAcronym || '',
    homeTeamLogo: data.home_club_logo || undefined,
    awayTeamId: data.away_club,
    awayTeamName: data.away_club_name,
    awayTeamShortName: data.away_club_short_name || data.awayTeamShortName || '',
    awayTeamAcronym: data.away_club_acronym || data.awayTeamAcronym || '',
    away_club_short_name: data.away_club_short_name || data.awayTeamShortName || '',
    away_club_acronym: data.away_club_acronym || data.awayTeamAcronym || '',
