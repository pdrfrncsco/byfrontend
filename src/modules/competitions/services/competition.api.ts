...
export function normalizeMatch(raw: Partial<Match> & Record<string, any>): Match {
  ...
  return {
    ...
    homeTeamShortName: raw.homeTeamShortName ?? raw.home_club_short_name ?? raw.home_team_short_name ?? '',
    home_club_short_name: raw.home_club_short_name ?? raw.homeTeamShortName ?? raw.home_team_short_name ?? '',
    homeTeamAcronym: raw.homeTeamAcronym ?? raw.home_club_acronym ?? raw.home_team_acronym ?? '',
    home_club_acronym: raw.home_club_acronym ?? raw.homeTeamAcronym ?? raw.home_team_acronym ?? '',
    ...
    awayTeamShortName: raw.awayTeamShortName ?? raw.away_club_short_name ?? raw.away_team_short_name ?? '',
    away_club_short_name: raw.away_club_short_name ?? raw.awayTeamShortName ?? raw.away_team_short_name ?? '',
    awayTeamAcronym: raw.awayTeamAcronym ?? raw.away_club_acronym ?? raw.away_team_acronym ?? '',
    away_club_acronym: raw.away_club_acronym ?? raw.awayTeamAcronym ?? raw.away_team_acronym ?? '',
