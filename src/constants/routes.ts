export const ROUTES = {
  ...
  DASHBOARD_CLUB_MEDIA: '/dashboard/club/media',
  ...
  CLUBS: '/clubs',
  PLAYERS: '/players',
  PLAYER_COMPARISON: '/players/comparison',
  ...
  DASHBOARD_PLAYER_CAREER: '/dashboard/player/career',
...
export const API_ROUTES = {
  ...
  PLAYERS: {
    ...
    GUARDIANS: (slug: string) => `/players/${slug}/guardians/`,
    GUARDIAN_DETAIL: (slug: string, id: string) => `/players/${slug}/guardians/${id}/`,
